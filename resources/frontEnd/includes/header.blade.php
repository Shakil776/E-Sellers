...
.top-center input.form-control, .top-center button.btn {
  display: inline-block;
  border: 1px solid #C21300;
  color: #000;
}
.top-center .my-cart-b.item_add{
  display: inline-block;
  padding: 5px 1em;
}
            ...
            <div class="top-center">
              <div>
                <form action="{{ route('search') }}" method="post">
                  ...
                  <button class="my-cart-b item_add" name="search"><i class="fa fa-search"></i></button>
                </form>
              </div>
            </div>
                ...
                <div class="cart box_1">
                  <a href="{{ route('show-wishlist') }}">
                    <h3> 
                      ...
                      <img src="{{ asset('frontEnd') }}/images/wishlist.png" alt="Wishlist" title="Wishlist Product" class="items" />
                    </h3>
                  </a>
                </div>  
                ...
                <div class="cart box_1" >
                  <a href="{{ route('show-cart') }}">
                    <h3> 
                      ...
                      <img src="{{ asset('frontEnd') }}/images/bag.png" alt="Shopping Cart" title="Shopping Cart" class="items" />
                    </h3>
                  </a>
  ...
  <div class="heder-bottom">
    ...
    <div id="search" class="search-icon">
      <div class="icon-times">
        <img src="{{ asset('frontEnd/images/times.png') }}" alt="">
      </div>
      <form action="{{ route('search') }}" method="POST" role="search">
          @csrf
          <input type="text" name="search" placeholder="Search here..">
        <button type="submit">
          <img src="{{ asset('frontEnd/images/search-black.png') }}" alt="" class="items" />
        </button>
      </form>
    </div>
