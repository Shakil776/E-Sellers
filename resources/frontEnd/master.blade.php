...
<head>
	...
	<link href="{{ asset('frontEnd') }}/css/style.css?v=1.0.1" rel="stylesheet" type="text/css" media="all" />
	...
	<!--search jQuery-->
		<script src="{{ asset('frontEnd') }}/js/main.js?v=1.0"></script>
	<!--search jQuery-->
...
<script>
	jQuery(document).ready(function($) {
		$(".search-items").click(function(event) {
			$("#search").addClass('remove-item');
		});
		$(".icon-times").click(function(){
			$("#search, button[type='submit']").removeClass('remove-item');
		});
